...
function generarFacturaPDF(array $datos, string $ruta_archivo): void {
    ...
    <body>
        ...
        +34 655000000<br>
        delete@standardinet.com</p>

        <p><strong>Cliente:</strong> <?= htmlspecialchars($datos['cliente'] ?? '') ?><br>
        <strong>DNI:</strong> <?= htmlspecialchars($datos['dni'] ?? '') ?><br>
        <strong>Teléfono:</strong> <?= htmlspecialchars($datos['telefono'] ?? '') ?><br>
        <strong>Email:</strong> <?= htmlspecialchars($datos['email'] ?? '') ?><br>
        <strong>Hora de entrega:</strong> <?= htmlspecialchars($datos['hora_entrega'] ?? '') ?><br>
        <strong>Hora de recogida:</strong> <?= htmlspecialchars($datos['hora_recogida'] ?? '') ?><br>
        <strong>Alojamiento:</strong> <?= htmlspecialchars($datos['direccion_alojamiento'] ?? '') ?></p>
