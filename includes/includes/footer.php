    ...
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
        ...
        <div class="col mb-2">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Mi garaje</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Asistencia</a></li>
        ...
        <div class="col mb-2">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Protección de datos</a></li>
            </ul>
        </div>
    </footer>
</div>